  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24">
      <div className="container">
        <h2 className="text-5xl sm:text-6xl text-center font-bold tracking-tighter">Everything you need</h2>
        ...
        <div className = "mt-16 sm:flex-row flex flex-col gap-4">
          {features.map(({ title, description }) => (
            <div key={title} className = "border border-white/30 px-5 py-10 sm:flex-1 text-center rounded-xl ">
