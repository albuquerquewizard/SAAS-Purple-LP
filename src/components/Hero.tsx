      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            ...
            <Image src={cursorImage} height="200" width="200" className="absolute right-[476px] top-[108px] hidden sm:inline" alt="cursor" />
            <Image src={messageImage} height="200" width="200" className="absolute left-[496px] top-[48px] hidden sm:inline" alt="message" />
          </div>
        </div>
